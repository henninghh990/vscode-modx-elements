...
## API
You can either create your own API or use one I've built spesific for this Extension. It's available on [extras.modx.com](https://extras.modx.com/package/modxelementsapi)

## Multiple MODX sites
You can easilty add all your MODX sites and work with ease.

#### Explorer view
![Multiple sites](media/treeview.png)

#### Adding a site
![Add site](media/add.png)
